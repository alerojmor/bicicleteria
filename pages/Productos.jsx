...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    useEffect(() => {
    document.title = "Bicicleteria | Productos";
    ...
    // Meta tags básicos
    updateMetaTag('description', 'Explora nuestro catálogo de bicicletas y accesorios para todos los niveles y estilos.');
    updateMetaTag('keywords', ' bicicletas, accesorios de ciclismo, bicicletas de montaña, bicicletas de carretera, cascos, ropa de ciclismo');
    updateMetaTag('author', '@webmaster');
    updateMetaTag('robots', 'index, follow');

    // Open Graph
    updateMetaTag('og:title', 'Tienda de Bicicletas y Accesorios', 'property');
    updateMetaTag('og:description', 'Explora nuestro catálogo de bicicletas y accesorios para todos los niveles y estilos.', 'property');
    updateMetaTag('og:type', 'website', 'property');
    updateMetaTag('og:image', 'https://instagram/colombike.2025', 'property');
